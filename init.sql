 ...
 INSERT INTO admin(
      id, "createdBy", "createdAt", "isDeleted", name, email, "phoneNumber", "_dataStatus", "updatedAt", "accountId", "role")
      VALUES ('dd143883-6e9a-4950-aefe-b04a8fa58028', 'injected', NOW(), false, 'admin',
       'admin@admin.com', '123', 'submitted', NOW(), 'dd143883-6e9a-4950-aefe-b04a8fa58028', 'admin');
